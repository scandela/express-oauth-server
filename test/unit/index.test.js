...
describe('ExpressOAuthServer', function () {
  ...
  describe('authenticate()', function () {
    it('should call `authenticate()`', function (done) {
      ...
      sinon.stub(oauth.server, 'authenticate').returns(Promise.resolve({}));
      ...
      request(server)
        ...
        .end(function () {
          ...
          oauth.server.authenticate.firstCall.args[0].should.be.an.instanceOf(
            Request
          );
          oauth.server.authenticate.firstCall.args[1].should.be.an.instanceOf(
            Response
          );
    ...
    it('should call `authenticate()` with options', function (done) {
      ...
      request(server)
        ...
        .end(function () {
          ...
          oauth.server.authenticate.firstCall.args[2].should.eql({
            options: true,
          });
          oauth.server.authenticate.restore();
          done();
  ...
  describe('authorize()', function () {
    it('should call `authorize()` and end middleware execution', function (done) {
      ...
      sinon.stub(oauth.server, 'authorize').returns(Promise.resolve({}));
      ...
      request(server)
        ...
        .end(function () {
          ...
          oauth.server.authorize.firstCall.args[0].should.be.an.instanceOf(
            Request
          );
          oauth.server.authorize.firstCall.args[1].should.be.an.instanceOf(
            Response
          );
    ...
    it('should call `authorize()` with options', function (done) {
      ...
      request(server)
        ...
        .end(function () {
          ...
          oauth.server.authorize.firstCall.args[2].should.eql({
            options: true,
          });
          oauth.server.authorize.restore();
          done();
  ...
  describe('token()', function () {
    it('should call `token()` and end middleware chain', function (done) {
      ...
      sinon.stub(oauth.server, 'token').returns(Promise.resolve({}));
      ...
      request(server)
        ...
        .end(function () {
          ...
          oauth.server.token.firstCall.args[1].should.be.an.instanceOf(
            Response
          );
